...
class LoginView(QDialog):
    def __init__(self, auth_controller=None, parent=None):
        ...
        self.setWindowTitle("Inicio de sesion - Sonrisa Perfecta")
        self.resize(420, 220)
        self._construir_ui()
    ...
    def _construir_ui(self):
        ...
        titulo = QLabel("Sistema de Gestion Clinica Dental Sonrisa Perfecta")
        titulo.setWordWrap(True)
        layout.addWidget(titulo)

        ayuda = QLabel(
            "Usuarios demo: admin/admin123, recepcion/recepcion123 y doctor/doctor123."
        )
        ...
        formulario.addRow("Contrasena:", self.input_password)
