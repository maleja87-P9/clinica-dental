...
class AuthController:
    ...
    def iniciar_sesion(self, username, password, codigo_mfa=""):
        ...
        # El robot de pruebas usará el código 123456 para entrar
